  ...
  hotUtilsCreateProfileModal() {
    ...
    const checkNameAndCreateProfile = function () {
      if ('' === categoryInput.value || '' === profileNameInput.value) {
        error.textContent = 'Vous devez fournir une catégorie et un nom pour votre profil';
      } else {
        error.textContent = '';
